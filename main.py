...
parser.add_argument("--model_name", 
                    default='llmesr_mean_sasrec',
                    choices=[
                    "llmesr_sasrec", "llmesr_bert4rec", "llmesr_gru4rec", "sasrec", "bert4rec", "gru4rec",
                    ...
                    # ICSRec + HSU Gated Fusion models
                    ...
                    # LLMEmb + GAA (Group-Aware Alignment) enhanced version
...
def main():
    ...
    logger, writer = log_manager.get_logger()    # get the logger  logger write log into /log/.txt  writer record tensorboard
    ...
    # Original models
    elif args.model_name in ['llmesr_mean_gru4rec', 'llmesr_gru4rec', "gru4rec", "gru4rec_llm2rec", "gru4rec_with_alignment",
                           "rcl_gru4rec", "rcl_hsu_gru4rec", "llmemb_gru4rec", "llmemb_gaa_gru4rec"]:  # GRU4Rec: pos is single value [B]
        generator = GeneratorAllUser(args, logger, device)
    elif args.model_name in ["llmesr_mean_bert4rec", "llmesr_bert4rec", "bert4rec", "bert4rec_llm2rec", "bert4rec_with_alignment",
                             "rcl_bert4rec", "rcl_hsu_bert4rec", "llmemb_bert4rec", "llmemb_gaa_bert4rec"]:  # Bert4Rec: pos is sequence [B, T]
        generator = BertGeneratorAllUser(args, logger, device)
    elif args.model_name in ["llmesr_mean_sasrec", "llmesr_sasrec", "sasrec", "sasrec_llm2rec", "sasrec_with_alignment",
                             "rcl_sasrec", "rcl_hsu_sasrec", "llmemb_sasrec", "llmemb_gaa_sasrec"]:  # SASRec: pos is sequence [B, T]
