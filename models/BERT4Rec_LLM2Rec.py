"""
Lightweight BERT4Rec + LLM2Rec integration
- BERT4Rec_LLM2Rec: Pure BERT4Rec backbone + LLM2Rec semantic insertion + adapter
- BERT4Rec_WithAlignment: Add similar user contrastive enhancement on top of BERT4Rec_LLM2Rec (reuse GAA_Mixin)
"""
import os
import numpy as np
import torch
...
class BERT4Rec_LLM2Rec(Bert4Rec):
    """
    Pure BERT4Rec + LLM2Rec semantic insertion + adapter
...
class BERT4Rec_WithAlignment(BERT4Rec_LLM2Rec, GAA_Mixin):
    """
    Add similar user contrastive enhancement on top of BERT4Rec_LLM2Rec (reuse GAA_Mixin)
    """
    ...
    def _log2feats_for_gaa(self, log_seqs, positions):
        """log2feats interface provided for GAA module"""
    ...
    def forward(self, seq, pos, neg, positions, **kwargs):
        ...
        # 1. Calculate base loss (from BERT4Rec_LLM2Rec)
        base_loss = super(BERT4Rec_WithAlignment, self).forward(seq, pos, neg, positions, **kwargs)
